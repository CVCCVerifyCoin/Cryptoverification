...
public:
    ...
    void setZCvccControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzCVCC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzCVCC_clicked();
    void on_pushButtonZCvccControl_clicked();
