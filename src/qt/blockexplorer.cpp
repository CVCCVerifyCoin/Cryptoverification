...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::CVCC, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (cryptoverification.conf).");
            QMessageBox::warning(this, "CryptoVerification Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#a33636;}\n a, span { font-family: monospace; }\n span.addr {color:#a33636; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #a33636;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#a33636;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#a33636;}\n";
