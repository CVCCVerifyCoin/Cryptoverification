...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CryptoVerification"),
     ...
     * override -datadir in the cryptoverification.conf file in the default data directory
     * (to be consistent with cryptoverificationd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
