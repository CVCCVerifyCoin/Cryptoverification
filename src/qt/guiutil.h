...
/** Utility functions used by the CryptoVerification Qt UI.
 */
namespace GUIUtil
{
...
// Render CryptoVerification addresses in monospace font
...
// Parse "cryptoverification:" URI into recipient object, return true on successful parsing
