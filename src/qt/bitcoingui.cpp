                                                                            ...
                                                                            spinnerFrame(0)
{
	...
	QString windowTitle = tr("CryptoVerification Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a CryptoVerification address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptoverification: URIs)"));
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CryptoVerification"), this);
	aboutAction->setStatusTip(tr("Show information about CryptoVerification"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setStatusTip(tr("Modify configuration options for CryptoVerification"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your CryptoVerification addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CryptoVerification addresses"));
	...
	openAction->setStatusTip(tr("Open a CryptoVerification: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the CryptoVerification help message to get a list with possible CryptoVerification command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("CryptoVerification client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoVerification network", "", count));
}
...
{
	QString strTitle = tr("CryptoVerification"); // default title
	...
	// Append title to "CryptoVerification - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
