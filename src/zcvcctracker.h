...
#ifndef CryptoVerification_ZCVCCTRACKER_H
#define CryptoVerification_ZCVCCTRACKER_H
...
public:
    CzCVCCTracker(std::string strWalletFile);
    ~CzCVCCTracker();
...
#endif //CryptoVerification_ZCVCCTRACKER_H
