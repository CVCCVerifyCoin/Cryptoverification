...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CryptoVerification cryptoverification-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptoverification-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptoverification transaction") + "\n" +
                               "  cryptoverification-tx [options] -create [commands]   " + _("Create hex-encoded cryptoverification transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptoverification transaction
