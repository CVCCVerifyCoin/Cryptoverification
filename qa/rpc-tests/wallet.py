...
#   c) node1 mines 32 blocks, so now node 0 has 60001cvcc, node 1 has 4250cvcc, node2 has none.
#   d) node0 sends 601 cvcc to node2, in two transactions (301 cvcc, then 300 cvcc).
