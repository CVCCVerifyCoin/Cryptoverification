...
This mechanism has been integrated into Bitcore-Node-CryptoVerification which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CryptoVerification-Project/insight-api-cryptoverification#web-socket-api](https://github.com/CryptoVerification-Project/insight-api-cryptoverification#web-socket-api) 
* API: [https://github.com/CryptoVerification-Project/insight-api-cryptoverification#swifttx-transactions](https://github.com/CryptoVerification-Project/insight-api-cryptoverification#swifttx-transactions) 
...
By default, the CryptoVerification daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CryptoVerification daemon:
