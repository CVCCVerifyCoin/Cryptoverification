...
In order to support loading of multiple wallets in cryptoverification-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptoverification.cpp.
...
Changes to cryptoverification.cpp
----------------------
cryptoverification.cpp is the entry point into cryptoverification-qt, and as such, will require some minor modifications to provide hooks for
