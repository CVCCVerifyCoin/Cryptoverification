Contributing to CryptoVerification
============================

The CryptoVerification project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to cryptoverification-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the cryptoverification unit tests or QA tests
...
The following applies to code changes to the CryptoVerification project, and is not to be
confused with overall CryptoVerification Network Protocol consensus changes.

Whether a pull request is merged into CryptoVerification rests with the project merge
...
Patches that change CryptoVerification consensus rules are considerably more involved than
...
Where a patch set proposes to change the CryptoVerification consensus, it must have been
...
The project leader is the release manager for each CryptoVerification release.
